                            ...
                            {prop.enum ? (
                              ...
                              prop.items?.enum ? (
                                ...
                                <textarea
                                  ...
                                  className="w-full px-3 py-2 bg-slate-50 dark:bg-surface-dark border border-slate-200 dark:border-white/5 rounded-xl text-xs outline-none focus:ring-2 focus:ring-primary/20 transition-all dark:text-white min-h-[80px] resize-y font-mono"
                                />
                              )
                            ) : type === 'boolean' ? (
